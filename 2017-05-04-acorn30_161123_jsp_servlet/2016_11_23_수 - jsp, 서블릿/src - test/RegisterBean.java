...
public class RegisterBean {
   ...
   private String mem_phone;
	...
	public String getMem_passwd() { return mem_passwd; }
	public void setMem_passwd(String mem_passwd) { this.mem_passwd = mem_repasswd; }
	
	public String getMem_repasswd() { return mem_repasswd; }
	public void setMem_repasswd(String mem_repasswd) { 	this.mem_repasswd = mem_repasswd; }
