...
angular.module('myApp').factory('UserService', ['$http', '$q', function($http, $q){
	...
	var REST_SERVICE_URI = 'http://jongwoo315.hopto.org:8080/dec_fifteen/user/';
			// uri vs url = information vs location //
			// user에 information이 들어 있다
			// RESTful 서비스는 명사로 주고 받는다.
	var factory = {
			fetchAllUsers: fetchAllUsers123,
			createUser: createUser123,
			updateUser: updateUser123,
			deleteUser: deleteUser123
	};
...
*/    
	...
	function updateUser123(user, id){
		var deferred = $q.defer();
